       ...
       <div class="col-md-9">
          ...
          <div class="panel panel-default">
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                       <form action="{{route('submit_announcement')}}" method="post">
              {{ csrf_field() }}
              ...
              <div class="form-group col-md-12">
               ...
               <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                            ...
                            <div class="col-md-8" class="form-control">
                              <input type="date" class="form-control" name="date" required="true" id="date">
                              <br>
                            </div>
              </div>
               ...
               <div class="form-group col-md-12">
                            ...
                            <div class="col-md-8" class="form-control">
                              <input type="time" class="form-control" name="time" required="true" id="time">
                              <br>
                            </div>
              </div>
