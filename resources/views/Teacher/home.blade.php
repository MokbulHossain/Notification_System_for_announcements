   ...
   <div class="row">
       ...
       <div class="col-md-9" id="data_show">
           <a class="btn btn-primary" onclick="edit()">Edit</a>
       	  @if($data->photo != null)
          <img src="{{url('storage/teacher_image/'.$data->id.'.jpg')}}" style="height: 200px;width: 200px;border-radius: 50%;margin-left:295px;">
          @else
          ...
          <table style="width: 80%;" class="table">
            ...
            <form method="post" action="{{route('update_teacher_info')}}" enctype="multipart/form-data">
              {{csrf_field()}}
          @if($data->photo != null)
          <img src="{{url('storage/teacher_image/'.$data->id.'.jpg')}}" id="image" style="height: 200px;width: 200px;border-radius: 50%;margin-left:295px;">
          @else
