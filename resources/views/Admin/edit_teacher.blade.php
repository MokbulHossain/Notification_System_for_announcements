        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('update_teacher') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                          ...
                          <div class="form-group{{ $errors->has('rank') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="rank" type="text" class="form-control" name="rank" value="{{ $data->rank }}" required autofocus>
